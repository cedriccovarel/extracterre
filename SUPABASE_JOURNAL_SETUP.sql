...
-- ExtracTerre v1.1.23 — lecture limitée de la mémoire d'apprentissage partagée.
-- Cette RPC n'expose PAS le journal complet : uniquement les signaux d'emplacement nécessaires au parseur.
